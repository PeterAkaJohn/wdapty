pub mod providers;
use anyhow::Result;
use providers::{aws::{Aws, AwsCredentials}, provider::ParseCredentials};
...
pub fn get_credentials(provider: &str, profile: Option<&str>, credentials_path: Option<String>) -> Result<AwsCredentials> {
